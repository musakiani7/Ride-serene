...
// @desc    Submit corporate inquiry form
...
// @route   GET /api/corporate/inquiries
...
exports.getAllInquiries = async (req, res) => {
  try {
    ...
    const count = await CorporateInquiry.countDocuments(query);
...
// @desc    Get single corporate inquiry (Admin only)
// @route   GET /api/corporate/inquiry/:id
// @access  Private/Admin
...
// @desc    Update corporate inquiry status (Admin only)
// @route   PUT /api/corporate/inquiry/:id
// @access  Private/Admin
...
// @desc    Delete corporate inquiry (Admin only)
// @route   DELETE /api/corporate/inquiry/:id
// @access  Private/Admin
